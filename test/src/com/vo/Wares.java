...
public String toString() {
	return "Wares [waresid=" + waresid + ", waresname=" + waresname
			+ ", waresprice=" + waresprice + ", waresnumber=" + waresnumber
			+ ", shopid=" + shopid + ", waresstate=" + waresstate
			+ ", warespicture=" + warespicture + ", waresclass=" + waresclass
			+ ", matkering=" + matkering + ", oldprice=" + oldprice + "]";
}
...
public Wares(int waresid, String waresname, Double waresprice, int waresnumber, int shopid, String waresstate,
		String warespicture, String waresclass, String matkering, Double oldprice) {
	super();
	this.waresid = waresid;
	this.waresname = waresname;
	this.waresprice = waresprice;
